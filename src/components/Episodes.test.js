...
export const episodesFixture = {"id":2993,
...
"schedule":{
    ...
    "days":["Thursday"]},
    "rating":{"average":8.7},
    "weight":99,"network":null,
    "webChannel":{
        "id":1,
        "name":"Netflix",
        "country":null},
        "externals":{"tvrage":48493,
        "thetvdb":305288,
        "imdb":"tt4574334"},
    "image":{
...
test("Episodes return with episode data", () => {
...
rerender(<Episodes error="" episodes={episodesFixture._embedded.episodes} />);
